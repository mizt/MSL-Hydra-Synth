...
struct FragmentShaderArguments {
  ...
  device float *r_14[[id(14)]];
  device float *g_15[[id(15)]];
  device float *b_16[[id(16)]];
  device float *a_17[[id(17)]];
  device float *frequency_18[[id(18)]];
  device float *sync_19[[id(19)]];
  device float *offset_20[[id(20)]];
  device float *r_21[[id(21)]];
  device float *g_22[[id(22)]];
  device float *b_23[[id(23)]];
  device float *a_24[[id(24)]];
  device float *angle_25[[id(25)]];
  device float *speed_26[[id(26)]];
  device float *pixelX_27[[id(27)]];
  device float *pixelY_28[[id(28)]];
  device float *nSides_29[[id(29)]];
  device float *scrollX_30[[id(30)]];
  device float *speed_31[[id(31)]];
  device float *amount_32[[id(32)]];
  device float *threshold_33[[id(33)]];
  device float *tolerance_34[[id(34)]];
  device float *reps_35[[id(35)]];
  device float *offset_36[[id(36)]];
  device float *reps_37[[id(37)]];
  device float *offset_38[[id(38)]];
  device float *frequency_39[[id(39)]];
  device float *sync_40[[id(40)]];
  device float *offset_41[[id(41)]];
  device float *amount_42[[id(42)]];
  device float *amount_43[[id(43)]];
  device float *xMult_44[[id(44)]];
  device float *yMult_45[[id(45)]];
  device float *offsetX_46[[id(46)]];
  device float *offsetY_47[[id(47)]];
};
...
fragment float4 fragmentShader(VertInOut inFrag[[stage_in]],constant FragmentShaderArguments &args[[buffer(0)]]) {
  ...
  float r_14 = args.r_14[0];
  float g_15 = args.g_15[0];
  float b_16 = args.b_16[0];
  float a_17 = args.a_17[0];
  float frequency_18 = args.frequency_18[0];
  float sync_19 = args.sync_19[0];
  float offset_20 = args.offset_20[0];
  float r_21 = args.r_21[0];
  float g_22 = args.g_22[0];
  float b_23 = args.b_23[0];
  float a_24 = args.a_24[0];
  float angle_25 = args.angle_25[0];
  float speed_26 = args.speed_26[0];
  float pixelX_27 = args.pixelX_27[0];
  float pixelY_28 = args.pixelY_28[0];
  float nSides_29 = args.nSides_29[0];
  float scrollX_30 = args.scrollX_30[0];
  float speed_31 = args.speed_31[0];
  float amount_32 = args.amount_32[0];
  float threshold_33 = args.threshold_33[0];
  float tolerance_34 = args.tolerance_34[0];
  float reps_35 = args.reps_35[0];
  float offset_36 = args.offset_36[0];
  float reps_37 = args.reps_37[0];
  float offset_38 = args.offset_38[0];
  float frequency_39 = args.frequency_39[0];
  float sync_40 = args.sync_40[0];
  float offset_41 = args.offset_41[0];
  float amount_42 = args.amount_42[0];
  float amount_43 = args.amount_43[0];
  float xMult_44 = args.xMult_44[0];
  float yMult_45 = args.yMult_45[0];
  float offsetX_46 = args.offsetX_46[0];
  float offsetY_47 = args.offsetY_47[0];
        
  return luma(colorama(diff(color(osc(scrollX(repeatX(repeatY(modulate(scale(st, amount_43, xMult_44, yMult_45, offsetX_46, offsetY_47), osc(scale(st, amount_43, xMult_44, yMult_45, offsetX_46, offsetY_47), frequency_39, sync_40, offset_41, time), amount_42), reps_37, offset_38), reps_35, offset_36), scrollX_30, speed_31, time), frequency_11, sync_12, offset_13, time), r_14, g_15, b_16, a_17), color(osc(rotate(pixelate(kaleid(scrollX(repeatX(repeatY(modulate(scale(st, amount_43, xMult_44, yMult_45, offsetX_46, offsetY_47), osc(scale(st, amount_43, xMult_44, yMult_45, offsetX_46, offsetY_47), frequency_39, sync_40, offset_41, time), amount_42), reps_37, offset_38), reps_35, offset_36), scrollX_30, speed_31, time), nSides_29), pixelX_27, pixelY_28), angle_25, speed_26, time), frequency_18, sync_19, offset_20, time), r_21, g_22, b_23, a_24)), amount_32), threshold_33, tolerance_34);
}
